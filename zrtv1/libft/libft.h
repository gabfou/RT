...
/*   Updated: 2016/06/11 21:19:22 by ibuchwal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					ft_dlist_remove(t_dlist **head,
	t_dlist *elem, t_deleter del);
...
void					ft_btree_insert(t_btree **root,
	t_btree *node, t_comparator cmp);
t_btree					*ft_btree_find(t_btree *node, void *n,
	size_t s, t_comparator cmp);
void					ft_btree_pre_foreach(t_btree *root,
	t_functor functor, void *d);
void					ft_btree_inf_foreach(t_btree *root,
	t_functor functor, void *d);
void					ft_btree_post_foreach(t_btree *root,
	t_functor functor, void *d);
t_btree					*ft_btree_remove(t_btree **r, void *n,
	size_t s, t_comparator cmp);
...
void					ft_map_insert(t_map map,
	t_map_entry entry, t_simple_hash_func h_f);
void					*ft_map_get(t_map map,
	void *key, t_simple_hash_func h_f);
t_map_entry				*ft_map_get_p(t_map map,
	void *key, t_simple_hash_func h_f);
void					ft_map_remove(t_map map,
	void *key, t_simple_hash_func f,
							t_map_deleter del);
void					ft_map_delete(t_map map, t_map_deleter del);
void					ft_map_foreach(t_map map,
	t_simple_functor functor, void *data);
